...
class SemanticVersion(object):
    ...
    def _sort_key(self):
        ...
        uq_dev = 0 if self._dev_count and not self._prerelease_type else 1
        return (
    ...
    def __repr__(self):
        return f"pbr.version.SemanticVersion({self.release_string()})"
    ...
    def from_pip_string(klass, version_string):
        ...
        if remainder_starts_with_int:
            ...
            if remainder and remainder[0][0] in ('0', 'a', 'b', 'r'):
    ...
    def decrement(self):
        ...
        if self._patch:
            ...
            if self._minor:
                ...
                new_minor = 9999
                new_major = self._major - 1 if self._major else 0
    ...
    def _long_version(self, pre_separator, rc_marker=""):
        ...
        if self._prerelease_type:
            segments.append(
                f"{pre_separator}{rc_marker}{self._prerelease_type}{self._prerelease}"
            )
        ...
        if self._prerelease_type:
            ...
            segments.extend(
                (
                    ...
                    (self._dev_count or self._prerelease),
                )
            )

        elif self._dev_count:
            segments.extend(('dev', self._dev_count - 1))
        else:
            segments.extend(('final', 0))
...
class VersionInfo(object):
    ...
    def __repr__(self):
        """Include the name."""
        return f"pbr.version.VersionInfo({self.package}:{self.version_string()})"
    ...
    def cached_version_string(self, prefix=""):
        ...
        if not self._cached_version:
            self._cached_version = f"{prefix}{self.version_string()}"
