...
class WebDriver(object):
    ...
    def _unwrap_value(self, value):
        if isinstance(value, dict) and ('ELEMENT' in value or 'element-6066-11e4-a52e-4f735466cecf' in value):
            if wrapped_id := value.get('ELEMENT', None):
    ...
    def maximize_window(self):
        ...
        """
        command = Command.W3C_MAXIMIZE_WINDOW if self.w3c else Command.MAXIMIZE_WINDOW
    ...
    def set_window_size(self, width, height, windowHandle='current'):
        ...
        """
        command = Command.W3C_SET_WINDOW_SIZE if self.w3c else Command.SET_WINDOW_SIZE
    ...
    def get_window_size(self, windowHandle='current'):
        ...
        """
        command = Command.W3C_GET_WINDOW_SIZE if self.w3c else Command.GET_WINDOW_SIZE
        size = self.execute(command,
            {'windowHandle': windowHandle})

        return size['value'] if size.get('value', None) != None else size
